...
const W = '~';   // bgTiles water = 海（徒歩不可・はしごで幅1だけ渡れる）
...
/**
 * 実手順の全探索ソルバー。廊下版（migrate-field-corridor-o.mjs）を拡張。
 * 状態 = プレイヤー位置 × 石位置 × Yトグルマスク × brokenWalls集合 × litTorches集合。
 * brokenWalls / litTorches は **不可逆な単調増加ビット**なので状態爆発しない。
 *
 ...
 */
function makeSolver(tiles, bg, linkSpec, breakDefs, litInit, { hasLadder = true, noTools = false } = {}) {
