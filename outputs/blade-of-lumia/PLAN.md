...
- [ ] **5.5g3. 剣・盾のティア別見た目差分（2026-08-08 ユーザー指摘・0番＝割り込み枠・🧠→⚡）**。**この位置の理由＝5.5g2 の直後にユーザーが指摘＝「剣と盾ってアイテム取得してレベルアップしたとき見た目も変わるようにしてたっけ？変わるようにした方がいい」。実装済みと思い込んで進めていた背景に「見た目が変わらない」を放置していたのは体験の欠落＝次の鍵部屋作業（5.5h以降）より先に直す。**
