...
- **進行中タスク：** **Phase 2-3 完了**。次は **Phase 2-4**（フィールドマップ拡張）🧠→⚡。
- **直近の状態：** Phase 2-3 完了。各ダンジョン入口付近に石碑（看板 `i`）×8 を配置し、テーマ名・危険情報・入口方向をヒントとして記述。フィールドNPC（タロ・すみっこずき・賢者エルン・ピンクあたま）の台詞に次のダンジョン方向の噂話を追加。**全37テストグリーン**。
...
| Phase 2 8ダンジョン | 🚧 進行中 | 2-1/2-2/2-3 完了（8ダンジョン体制・ボス固有化・石碑&NPC噂話ヒント）。次は 2-4（フィールドマップ拡張）|
| Phase 3 アクション深化 | 🔲 未着手 | |
| Phase 4 サブアイテム | 🔲 未着手 | |
| Phase 5 謎解き | 🔲 未着手 | |
| Phase 6 世界観・NPC | 🔲 未着手 | |
