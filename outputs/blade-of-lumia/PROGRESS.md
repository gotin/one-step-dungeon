...
- **進行中タスク：** 次は **Phase 1-3**（ゲーム終盤フローの変更：8個集めたら祭壇へ誘導）🧠
- **直近の状態：** Phase 1-2 完了。最初の村に老賢者NPC（タイル `b`）を配置し、ストーリー導入台詞を設定。29テストグリーン。
...
| Phase 1 ストーリー基盤 | 🚧 進行中 | 1-1・1-2 完了（名称変更・エンディング書き直し・老賢者NPC配置）。次は 1-3 終盤フロー変更 |
